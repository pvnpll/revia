...
| [releases/v1.6.1.md](./releases/v1.6.1.md) | Latest release notes |
...
| Document | Topic |
|----------|-------|
| [DEPLOY-VERCEL.md](./DEPLOY-VERCEL.md) | Vercel + Supabase deployment |
| [TESTING.md](./TESTING.md) | Local setup, manual QA, automated tests |
