...
**Last updated:** September 2026 — **v1.7.3-preview.1** (Study viewer gesture & rating fixes, develop preview; production on **v1.7.2**)\
...
| **v1.7.3-preview.1** | 🧪 Preview (develop) | Study viewer gesture & rating fixes (Fix #3) | UX polish |
